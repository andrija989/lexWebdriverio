 ...
 describe('Role - org.overview - API automation - login and store token ->', function() {
  ...
  it('Role - org.overview - go to administration page', function() {
  ...
  var token = ''
  it('Role - org.overview - get token', function() {
    allureReporter.addFeature('API automation')
  ...
  it('Role - org.overview - set token', function() {
    var executor = token
    ...
    if (err) throw err;
      color.log('The file with org.overview token has been saved!', 'success');
    });
  })
 });
