...
describe('API automation - roles - supervisor ->', function() {
  ...
  var testOrg = ''
  it('Role - supervisor - GET organisation', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
  ...
  it('Role - supervisor - POST organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    browser.call(() => {
  ...
  it('Role - supervisor - EDIT organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - supervisor - DELETE organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  var user = ''
  it('Role - supervisor - POST user invite - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var schoolID = ''
  it('Role - supervisor - POST school - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - supervisor - EDIT school name - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - supervisor - EDIT school name - revert to old one - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - supervisor - GET school', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var classID = ''
  it('Role - supervisor - POST class - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - supervisor - POST student - grade 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    var org = orgForAll
  ...
  it('Role - supervisor - POST student - grade 4 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - supervisor - POST student - grade 6 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - supervisor - POST student - grade 8 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var allStudents = ''
  it('Role - supervisor - GET all students', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - supervisor - POST import students - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - supervisor - POST import students - UK import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - supervisor - POST import students - NORWAY import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - supervisor - POST import students - FRANCE import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - supervisor - POST import students - PORTUGAL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - supervisor - POST import students - BRASIL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - supervisor - EDIT - Hide recording RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - supervisor - EDIT - Hide recording and comment back to seen RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - supervisor - EDIT - Comment as empty string RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
  ...
  it('Role - supervisor - EDIT - Hide recording and comment TEXT 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - supervisor - EDIT - UnHide recording and comment TEXT 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - supervisor - Hide recording and comment TEXT 2 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - supervisor - EDIT - Comment session - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - supervisor - delete token', function() {
    allureReporter.addFeature('API automation - Role - supervisor')
