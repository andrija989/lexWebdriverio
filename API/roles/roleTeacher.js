...
describe('API automation - roles - teacher ->', function() {
  ...
  var testOrg = ''
  it('Role - teacher - GET organisation', function() {
    allureReporter.addFeature('API automation - Role - teacher')
  ...
  it('Role - teacher - POST organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    browser.call(() => {
  ...
  it('Role - teacher - EDIT organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - teacher - DELETE organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  var user = ''
  it('Role - teacher - POST user invite - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var schoolID = ''
  it('Role - teacher - POST school - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - teacher - EDIT school name - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - teacher - EDIT school name - revert to old one - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - teacher - GET school', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var classID = ''
  it('Role - teacher - POST class - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
    ...
    console.log(`${config.originUrl}/classes/${org}/school/${school}/periods/${classPeriod}/classes`)
    browser.call(() => {
  ...
  it('Role - teacher - POST student - grade 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    var org = orgForAll
  ...
  it('Role - teacher - POST student - grade 4 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - teacher - POST student - grade 6 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - teacher - POST student - grade 8 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var allStudents = ''
  it('Role - teacher - GET all students', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - teacher - POST import students - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - teacher - POST import students - UK import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - teacher - POST import students - NORWAY import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - teacher - POST import students - FRANCE import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - teacher - POST import students - PORTUGAL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - teacher - POST import students - BRASIL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - teacher - EDIT - Hide recording RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - teacher - EDIT - Hide recording and comment back to seen RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - teacher - EDIT - Comment as empty string RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
  ...
  it('Role - teacher - EDIT - Hide recording and comment TEXT 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - teacher - EDIT - UnHide recording and comment TEXT 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - teacher - Hide recording and comment TEXT 2 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - teacher - EDIT - Comment session - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - teacher')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - teacher - delete token', function() {
    allureReporter.addFeature('API automation - Role - teacher')
