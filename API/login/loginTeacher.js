 ...
 describe('Role - teacher - API automation - login and store token ->', function() {
  ...
  it('Role - teacher - go to administration page', function() {
  ...
  var token = ''
  it('Role - teacher - get token', function() {
    allureReporter.addFeature('API automation')
  ...
  it('Role - teacher - set token', function() {
    var executor = token
    ...
    if (err) throw err;
      color.log('The file with teacher token has been saved!', 'success');
    });
  })
 });
