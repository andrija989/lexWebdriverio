...
describe('API automation - roles - principal ->', function() {
  ...
  var testOrg = ''
  it('Role - principal - GET organisation', function() {
    allureReporter.addFeature('API automation - Role - principal')
  ...
  it('Role - principal - POST organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    browser.call(() => {
  ...
  it('Role - principal - EDIT organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - principal - DELETE organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  var user = ''
  it('Role - principal - POST user invite - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var schoolID = ''
  it('Role - principal - POST school - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - principal - EDIT school name - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - principal - EDIT school name - revert to old one - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - principal - GET school', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var classID = ''
  it('Role - principal - POST class - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - principal - POST student - grade 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    var org = orgForAll
  ...
  it('Role - principal - POST student - grade 4 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - principal - POST student - grade 6 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - principal - POST student - grade 8 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var allStudents = ''
  it('Role - principal - GET all students', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - principal - POST import students - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - principal - POST import students - UK import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - principal - POST import students - NORWAY import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - principal - POST import students - FRANCE import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - principal - POST import students - PORTUGAL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - principal - POST import students - BRASIL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - principal - EDIT - Hide recording RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - principal - EDIT - Hide recording and comment back to seen RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - principal - EDIT - Comment as empty string RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
  ...
  it('Role - principal - EDIT - Hide recording and comment TEXT 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - principal - EDIT - UnHide recording and comment TEXT 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - principal - Hide recording and comment TEXT 2 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - principal - EDIT - Comment session - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - principal')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - principal - delete token', function() {
    allureReporter.addFeature('API automation - Role - principal')
