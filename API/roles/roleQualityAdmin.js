...
describe('API automation - roles - quality admin ->', function() {
  ...
  var testOrg = ''
  it('Role - QA - GET organisation', function() {
    allureReporter.addFeature('API automation - Role - QA')
  ...
  it('Role - QA - POST organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    browser.call(() => {
  ...
  it('Role - QA - EDIT organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - QA - DELETE organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  var user = ''
  it('Role - QA - POST user invite - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var schoolID = ''
  it('Role - QA - POST school - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - QA - EDIT school name - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - QA - EDIT school name - revert to old one - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - QA - GET school', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var classID = ''
  it('Role - QA - POST class - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - QA - POST student - grade 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    var org = orgForAll
  ...
  it('Role - QA - POST student - grade 4 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - QA - POST student - grade 6 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - QA - POST student - grade 8 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var allStudents = ''
  it('Role - QA - GET all students', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - QA - POST import students - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - QA - POST import students - UK import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - QA - POST import students - NORWAY import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - QA - POST import students - FRANCE import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - QA - POST import students - PORTUGAL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - QA - POST import students - BRASIL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - QA - EDIT - Hide recording RAN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    ...
    console.log(`${config.originUrl}/screenings/${org}/class/${classid}/recording/${record}/remove`)
    browser.call(() => {
  ...
  it('Role - QA - EDIT - Hide recording and comment back to seen RAN', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - QA - EDIT - Comment as empty string RAN', function() {
    allureReporter.addFeature('API automation - Role - QA')
  ...
  it('Role - QA - EDIT - Hide recording and comment TEXT 1', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - QA - EDIT - UnHide recording and comment TEXT 1', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - QA - Hide recording and comment TEXT 2', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - QA - EDIT - Comment session', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - QA - DELETE - Comment session', function() {
    allureReporter.addFeature('API automation - Role - QA')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - QA - delete token', function() {
    allureReporter.addFeature('API automation - Role - QA')
