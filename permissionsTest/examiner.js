...
describe('examiner permisions ->', function() {
  ...
  it('only one organisation is displayed', function() {
    allureReporter.addFeature('Permissions test')
  ...
  it('add organisation - no permission', function() {
    allureReporter.addFeature('Permissions test')
    allureReporter.addSeverity('Minor')
    const addOrg = administratorPage.addOrganisation.isDisplayed();
    expect(addOrg).to.eql(false);
  });
  ...
  it('can invite only predefined roles', function() {
    ...
    let count = 0;
    const roles = $$(
      'div[data-automation-id="select-role-UserAdministrator"] > div > label > select > optgroup > option'
    );
  ...
  //   var studentBithday = schoolPage.studentBirthdayTable.isDisplayed();
  ...
  it('can access recordings - no permission', function() {
    allureReporter.addFeature('Permissions test')
    allureReporter.addSeverity('Critical')
  ...
  it('select school', function() {
    ...
    const school = navbar.selectSchoolButton;
    school.waitForEnabled(5000);
    navbar.selectSchool('Brazil');
  });

  it('check if can access to school without permission', function() {
    allureReporter.addFeature('Permissions test')
    allureReporter.addSeverity('Critical')
    let school2 = $('a[data-automation-id="filter-grid-item-link-Grade 2"]').isClickable()
    expect(school2).to.eql(false);
    let school3 = $('a[data-automation-id="filter-grid-item-link-Grade 3"]').isClickable()
    expect(school3).to.eql(false);
    let school4 = $('a[data-automation-id="filter-grid-item-link-Grade 4"]').isClickable()
    expect(school4).to.eql(false);
    let school5 = $('a[data-automation-id="filter-grid-item-link-Grade 5"]').isClickable()
    expect(school5).to.eql(false);
  })

  it('logout examiner', function() {
    allureReporter.addFeature('Permissions test')
    allureReporter.addSeverity('Critical')
