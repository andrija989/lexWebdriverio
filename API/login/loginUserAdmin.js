...
describe('Role - user admin - API automation - login and store token ->', function() {
  ...
  it('Role - user admin - go to administration page', function() {
  ...
  var token = ''
  it('Role - user admin - get token', function() {
    allureReporter.addFeature('API automation')
  ...
  it('Role - user admin - set token', function() {
    var executor = token
    ...
    if (err) throw err;
      color.log('The file with user admin token has been saved!', 'success');
    });
  })
});
