...
describe('API automation - email filter - admin token ->', function() {
  ...
  it('GET - email doesnt exists - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
      return Axios.post(`${config.originUrl}/results/subjects/find?email`,
      {
        EmailAddressList: ["students@gmail.com"]
      },
      {
        headers: {
          Authorization: `Bearer ${access_token}`
  ...
  it('GET - email doesnt have permission for that student - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
  ...
  it('GET - chain emails - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
  ...
  it('GET - filter email - expect json data order - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
  ...
  it('GET - filter email with org - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
  ...
  it('GET - filter email with org - fake email - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
  ...
  it('GET - filter email with org - email doesnt have permission for that student - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
  ...
  it('GET - filter email with org - chain email - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
  ...
  it('GET - filter email with org - expect json data order - admin token', function() {
    allureReporter.addFeature('API automation - email filter')
    allureReporter.addSeverity('Normal')
    let access_token = token.access_token
    browser.call(() => {
