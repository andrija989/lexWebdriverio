 ...
 describe('Test Schools - Examiner Admin ->', function() {
   login(config.ExAdminEmail, config.ExAdminPassword)
   let currentUrl = '';
   let report = new Array()
   let errors = new Array()
 
   it('Test Schools - Examiner Admin - check url', function() {
   ...
   it('Test Schools - Examiner Admin - open test organisation', function() {
   ...
   it('Test Schools - Examiner Admin - create test school', function() {
     allureReporter.addFeature('Regression')
     allureReporter.addSeverity('Critical')
   ...
   it('Test Schools - Examiner Admin - select school', function() {
     allureReporter.addFeature('Regression')
     allureReporter.addSeverity('Critical')
   ...
   it('Test Schools - Examiner Admin - create class', function() {
     allureReporter.addFeature('Regression')
     allureReporter.addSeverity('Critical')
   ...
   it('Test Schools - Examiner Admin - select grade', function() {
     allureReporter.addFeature('Regression')
     allureReporter.addSeverity('Critical')
   ...
   it('Test Schools - Examiner Admin - add student', function() {
     allureReporter.addFeature('Regression')
     allureReporter.addSeverity('Critical')
   ...
   it('Test Schools - Examiner Admin - remove school', function() {
     allureReporter.addFeature('Regression')
     allureReporter.addSeverity('Critical')
  ...
  it('create error report', function() {
    if(errors.length != 0) {
      ...
      var fs = require('fs');
      fs.writeFile("./test/selenium/errors/errorsCrudSchoolExaminer.json", executorJson, function(err, result) {
      });
    }
