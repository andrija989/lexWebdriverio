...
describe('API automation - roles - org.overview ->', function() {
  ...
  var testOrg = ''
  it('Role - org.overview - GET organisation', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
  ...
  it('Role - org.overview - POST organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    browser.call(() => {
  ...
  it('Role - org.overview - EDIT organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - org.overview - DELETE organisation - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  var user = ''
  it('Role - org.overview - POST user invite - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var schoolID = ''
  it('Role - org.overview - POST school - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - org.overview - EDIT school name - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - org.overview - EDIT school name - revert to old one - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - org.overview - GET school', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var classID = ''
  it('Role - org.overview - POST class - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - org.overview - POST student - grade 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    var org = orgForAll
  ...
  it('Role - org.overview - POST student - grade 4 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - org.overview - POST student - grade 6 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - org.overview - POST student - grade 8 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  var allStudents = ''
  it('Role - org.overview - GET all students', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - org.overview - POST import students - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = orgForAll
  ...
  it('Role - org.overview - POST import students - UK import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - org.overview - POST import students - NORWAY import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - org.overview - POST import students - FRANCE import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - org.overview - POST import students - PORTUGAL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - org.overview - POST import students - BRASIL import - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - org.overview - EDIT - Hide recording RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
  ...
  it('Role - org.overview - EDIT - Hide recording and comment back to seen RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - org.overview - EDIT - Comment as empty string RAN - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
  ...
  it('Role - org.overview - EDIT - Hide recording and comment TEXT 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - org.overview - EDIT - UnHide recording and comment TEXT 1 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - org.overview - Hide recording and comment TEXT 2 - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - org.overview - EDIT - Comment session - FORBIDEN', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
    allureReporter.addSeverity('Blocker')
    const access_token = token.access_token
    const org = config.orgForAll
  ...
  it('Role - org.overview - delete token', function() {
    allureReporter.addFeature('API automation - Role - org.overview')
